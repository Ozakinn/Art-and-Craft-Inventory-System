...
class myFunctions:
            ...
            if( userinputVI.isdigit()):
                if userinputVI == "1":
                    ...
                    if self.itemreader == 20:
                        ...
                        print(" ")
                        print("            Select only the input that was given below.")
    ...
    def viewInventory(self):
        ...
        if select == 1:
            ...
            if self.itemreader == 20:
                print(colored("   -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-",'magenta'))
                print(colored("       [1]Back",'red'),colored("         [2]Modify",'red'),colored("         [4]Next Page",'red'),colored("         [9]Delete Item",'red'))
                print(colored("   ===============================================================================",'green'))
                print("  ")
                ...
                if "." in VIpagelimit2:
                    ...
                    print(colored("   ===============================================================================",'green'))
                    print("  ")
                elif VIpagelimit2 == str(VIpagelimit1):
                    print(colored("   -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-",'magenta'))
